...
import { PromptSuggestions } from "@renderer/components/ui/prompt-suggestions"
    ...
    >
      ...
      {!shouldAutoScroll && (
        <div className="pointer-events-none flex flex-1 items-end justify-end [grid-column:1/1] [grid-row:1/1]">
          <div className="sticky bottom-2 left-0 flex w-full justify-end pr-4">
            <Button
              onClick={scrollToBottom}
              className="pointer-events-auto h-8 w-8 rounded-full bg-background shadow-md border ease-in-out animate-in fade-in-0 slide-in-from-bottom-1 hover:bg-accent"
              size="icon"
              variant="outline"
            >
