...
**本项目已升级至 Node.js 24**。请查看 [NODE_24_UPGRADE.md](./NODE_24_UPGRADE.md) 了解升级详情和安装指南。
...
**前端**: React 19.1、TypeScript 5.8、Tailwind CSS 3.4  
**后端**: Electron 35.3、Node.js 24.x、better-sqlite3 11.9、node-llama-cpp 3.17  
**构建**: Webpack 5.98、Vite 6.2
